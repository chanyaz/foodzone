package com.test.foodzone.constants;

import com.test.foodzone.R;

/**
 * Created by Gokul on 11/29/2017.
 */
...
public class Constants
{
    ...
    public static final int imagesIntro[] ={R.drawable.ic_memories,R.drawable.ic_chat,R.drawable.ic_alert};

    public static final int imagesSplash[]= {R.drawable.d1,R.drawable.d2,R.drawable.d3};

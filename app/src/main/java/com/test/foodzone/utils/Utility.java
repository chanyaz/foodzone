package com.test.foodzone.utils;
...
public class Utility
{
    ...
    public static void showSnackBar(Activity activity, CoordinatorLayout coordinatorLayout, String text, int type)
    {
        ...
        if (type==2)
            ...
            txtMessage.setTextColor(Color.parseColor("#34cd27"));
        else
        {
            txtMessage.setTextColor(Color.parseColor("#CD1439"));
        }
        //txtMessage.Typeface = Typeface.CreateFromAsset(activity.Assets, "Medium.ttf");

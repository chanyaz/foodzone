package com.maya.wadmin.fragments.fleet;
 ...
 * Use the {@link FleetHomeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FleetHomeFragment extends Fragment implements IFragment , ITopBarAdapter {
    ...
    List<TopBarPanel> listTopBarPanel = Utility.getTopBarPanelElements(7);
    int previous = 0;
    ...
    int vehiclesType[] = {7,8,9};

    TextView tvAssign;



    public FleetHomeFragment() {
    ...
    public static FleetHomeFragment newInstance(String param1, String param2) {
        FleetHomeFragment fragment = new FleetHomeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fleet_home, container, false);
        ...
        viewPager.setAdapter(new VehiclesTypeAdapter(getFragmentManager(),789,stringList,vehiclesType));
        ...
        else
        {
            ...
            switch (position)
            {
                ...
                case 1:
                    ...
                    getChildFragmentManager().beginTransaction().replace(R.id.frameLayout, PDIViewFragment.newInstance("fleet",null)).commit();

...
public class ViolationsByDataAdapter extends RecyclerView.Adapter<ViolationsByDataAdapter.ViewHolder>
{
    ...
    public ViolationsByDataAdapter(List<Violation> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.all_violation_item,parent,false));
    }

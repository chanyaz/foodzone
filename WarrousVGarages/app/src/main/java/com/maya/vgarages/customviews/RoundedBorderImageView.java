package com.maya.vgarages.customviews;
...
{
    public static final String TAG = "RoundedBorderImageView";
    ...
    public RoundedBorderImageView(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        this.isOval = false;
        this.mRadii = new float[]{0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F};
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundedBorderImageView, defStyle, 0);
        int index = a.getInt(R.styleable.RoundedBorderImageView_android_scaleType, -1);
        if(index >= 0) {
            this.setScaleType(sScaleTypeArray[index]);
        }

        this.mLeftTopCornerRadius = (float)a.getDimensionPixelSize(R.styleable.RoundedBorderImageView_left_top_corner_radius, 0);
        this.mRightTopCornerRadius = (float)a.getDimensionPixelSize(R.styleable.RoundedBorderImageView_right_top_corner_radius, 0);
        this.mLeftBottomCornerRadius = (float)a.getDimensionPixelSize(R.styleable.RoundedBorderImageView_left_bottom_corner_radius, 0);
        this.mRightBottomCornerRadius = (float)a.getDimensionPixelSize(R.styleable.RoundedBorderImageView_right_bottom_corner_radius, 0);
        if(this.mLeftTopCornerRadius >= 0.0F && this.mRightTopCornerRadius >= 0.0F && this.mLeftBottomCornerRadius >= 0.0F && this.mRightBottomCornerRadius >= 0.0F) {
            ...
            this.mBorderWidth = (float)a.getDimensionPixelSize(R.styleable.RoundedBorderImageView_border_width, 0);
            if(this.mBorderWidth < 0.0F) {
                throw new IllegalArgumentException("border width cannot be negative.");
            } else {
                this.mBorderColor = a.getColorStateList(R.styleable.RoundedBorderImageView_border_color);
                if(this.mBorderColor == null) {
                    this.mBorderColor = ColorStateList.valueOf(-16777216);
                }

                this.isOval = a.getBoolean(R.styleable.RoundedBorderImageView_oval, false);
                a.recycle();
                this.updateDrawable();
            }
        } else {
    ...
    public void setImageDrawable(Drawable drawable) {
        this.mResource = 0;
        this.mDrawable = RoundedBorderImageView.SelectableRoundedCornerDrawable.fromDrawable(drawable, this.getResources());
    ...
    public void setImageBitmap(Bitmap bm) {
        this.mResource = 0;
        this.mDrawable = RoundedBorderImageView.SelectableRoundedCornerDrawable.fromBitmap(bm, this.getResources());
        super.setImageDrawable(this.mDrawable);
        this.updateDrawable();
    }
    ...
    private Drawable resolveResource() {
        ...
        if(rsrc == null) {
            ...
            return RoundedBorderImageView.SelectableRoundedCornerDrawable.fromDrawable(d, this.getResources());
        }
    }
    ...
    private void updateDrawable() {
        try {
            ...
            if (this.mDrawable != null) {
                ((RoundedBorderImageView.SelectableRoundedCornerDrawable) this.mDrawable).setScaleType(this.mScaleType);
                ((RoundedBorderImageView.SelectableRoundedCornerDrawable) this.mDrawable).setCornerRadii(this.mRadii);
                ((RoundedBorderImageView.SelectableRoundedCornerDrawable) this.mDrawable).setBorderWidth(this.mBorderWidth);
                ((RoundedBorderImageView.SelectableRoundedCornerDrawable) this.mDrawable).setBorderColor(this.mBorderColor);
                ((RoundedBorderImageView.SelectableRoundedCornerDrawable) this.mDrawable).setOval(this.isOval);
            }
        }
        catch (Exception e)
        {
    ...
    static class SelectableRoundedCornerDrawable extends Drawable
    {
        ...
        public static RoundedBorderImageView.SelectableRoundedCornerDrawable fromBitmap(Bitmap bitmap, Resources r) {
            return bitmap != null?new RoundedBorderImageView.SelectableRoundedCornerDrawable(bitmap, r):null;
        }

        public static Drawable fromDrawable(Drawable drawable, Resources r) {
            if(drawable != null) {
                if(drawable instanceof RoundedBorderImageView.SelectableRoundedCornerDrawable) {
                    return drawable;
                }
                ...
                if(bm != null) {
                    return new RoundedBorderImageView.SelectableRoundedCornerDrawable(bm, r);
                }

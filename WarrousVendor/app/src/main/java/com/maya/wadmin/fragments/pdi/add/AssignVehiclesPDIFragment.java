 ...
 */
public class AssignVehiclesPDIFragment extends Fragment implements IFragment,IAssignPDIVehiclesAdapter {
    ...
    public AssignVehiclesPDIFragment() {
    ...
    public static AssignVehiclesPDIFragment newInstance(String param1, String param2) {
        AssignVehiclesPDIFragment fragment = new AssignVehiclesPDIFragment();
    ...
    public void fetchAssignVehiclesForPDI()
    {
        progressBar.setVisibility(View.VISIBLE);
        String URL = Constants.URL_PDI_VEHICLES + "9" + "&DealerId=" + Utility.getString(Utility.getSharedPreferences(),Constants.DEALER_ID);

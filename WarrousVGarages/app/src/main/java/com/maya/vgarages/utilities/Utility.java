...
public class Utility
{
    ...
    public static List<Garage> generateGaragesList()
    {
        ...
        g1.Name = "Asd Garage";
        g1.Image = "https://media.gettyimages.com/photos/car-mechanic-using-tools-picture-id924923446";
        g1.Distance = "50";
        g1.Value = "5.3";
        g1.Location = "Madhapur, Hyderabad";
        g1.PriceRange = 3;
        g1.isOpen = true;

        Garage g2 = new Garage();
        g2.Name = "DVV Garage";
        g2.Image = "https://media.gettyimages.com/photos/cars-on-lifts-in-auto-repair-shop-picture-id188075212";
        g2.Distance = "200";
        g2.Value = "9.3";
        g2.Location = "Madhapur, Hyderabad";
        g2.PriceRange = 2;
        g2.isOpen = false;
        ...
        g3.Name = "Maya Garage";
        g3.Image = "https://media.gettyimages.com/photos/car-on-lift-in-auto-repair-shop-picture-id188075213";
        g3.Distance = "500";
        g3.Value = "7.5";
        g3.Location = "Hi-Tech, Hyderabad";
        g3.PriceRange = 4;
        g3.isOpen = true;
        ...
        g4.Image = "https://media.gettyimages.com/photos/tools-on-cart-in-auto-repair-shop-picture-id188075211";
        g4.Distance = "900";
        g4.Value = "8.3";
        g4.Location = "Kondapur, Hyderabad";
        g4.PriceRange = 2;
        g4.isOpen = false;
        ...
        g5.Image = "https://media.gettyimages.com/photos/car-repair-shop-in-japan-picture-id669872522";
        g5.Distance = "1500";
        g5.Value = "5.3";
        g5.Location = "Gachibowli, Hyderabad";
        g5.PriceRange = 3;
        g5.isOpen = true;
        ...
        g6.Image = "https://media.gettyimages.com/photos/auto-repair-shop-car-garage-picture-id176712668";
        g6.Distance = "1550";
        g6.Value = "9.2";
        g6.Location = "Gachibowli, Hyderabad";
        g6.PriceRange = 0;
        g6.isOpen = true;
    ...
    public static List<Review> generateReviews()
    {
        ...
        r0.UserName = "Kate Margarita";
        r0.Content = "You've done it again! Thank you for helping a damsel in distress, you repaired one tyre and replaced another even though I didn't have an appointment, thank you.";
        r0.Image = "https://media.gettyimages.com/photos/young-woman-shopping-online-picture-id613241502";
        r0.Ratting = "8";
        r0.TimeAgo = "23 hours ago";

        Review r1 = new Review();
        r1.UserName = "Enay Bill";
        r1.Content = "Even though it was a really busy period for them they were able to fit in my repair when my car broke down. The team were very friendly and helpful and I'll definitely use Squire Furneaux Guildford again";
        r1.Image = "https://d2e70e9yced57e.cloudfront.net/wallethub/posts/29912/eric-klinenberg.jpg";
        r1.Ratting = "9.3";
        r1.TimeAgo = "1 day ago";


        Review r2 = new Review();
        r2.UserName = "Henry David";
        r2.Content = "Had my MOT carried out here and have booked in for additional repairs to be carried out. Would definately recommend to friends and family";
        r2.Image = "https://www.cs.ox.ac.uk/files/8640//profile.jpg";
        r2.Ratting = "7.8";
        r2.TimeAgo = "3 days ago";

        Review r3= new Review();
        r3.UserName = "Christin Curie";
        r3.Content = "Due to a misunderstanding the 2 new tyres were fitted on the rear by mistake. However this was quickly rectified with the incorrectly removed tyres refitted and new tyres moved to the front. Have used Chemix for exhausts and tyres for years, always good value";
        r3.Image = "https://www.radioproject.org/wp-content/uploads/2011/02/0711.jpg";
        r3.Ratting = "9.5";
        r3.TimeAgo = "18 days ago";

        Review r4 = new Review();
        r4.UserName = "John Rayie";
        r4.Content = "First Class as usual";
        r4.Image = "https://edb-cdn-prod-tqgiyve.stackpathdns.com/players/icons/9e71815e-cabb-11e7-be93-0e6c723feec8.png";
        r4.Ratting = "10";
        r4.TimeAgo = "1 month ago";

        Review r5 = new Review();
        r5.UserName = "Gates Johnson";
        r5.Content = "Avoid at any cost!!!";
        r5.Image = "http://www.unitytubes.com/wp-content/uploads/2017/07/DAVIDO-4-150x150.png";
        r5.Ratting = "4.5";
        r5.TimeAgo = "2 months ago";

        Review r6 = new Review();
        r6.UserName = "Catherine Ton";
        r6.Content = "Brilliant customer service, knowledgeable and friendly staff.";
        r6.Image = "https://media.gettyimages.com/photos/photo-of-a-woman-using-smart-phone-picture-id647677346";
        r6.Ratting = "8";
        r6.TimeAgo = "2 months ago";
    ...
    public static List<GarageService> generateGarageServices()
    {
        ...
        gs1.Name = "Oil Change";
        gs1.Price = "1500";
        gs1.Content = "Regularly changing your car's engine oil and filter are one of the most important things you can do to keep your car running well.";
        gs1.Image = "https://media.gettyimages.com/photos/engine-oil-picture-id184832880";
        gs1.Tag = true;
        ...
        gs2.Name = "Replace AC Air Filter";
        gs2.Price = "3000";
        gs2.Content = "To change or clean the air filter in the central air system, first ensure that the system is off. Locate the filter inside of the furnace (or air handler for electric systems).";
        gs2.Image = "https://media.gettyimages.com/photos/automotive-air-filter-replacement-picture-id184348820";
        gs2.Tag = false;
        ...
        gs3.Name = "Car wash \nInterior / Exterior ";
        gs3.Price = "600";
        gs3.Content = "With a damp cloth we dust the dash, steering wheel, and center console";
        gs3.Image = "https://media.gettyimages.com/photos/convertible-going-through-car-wash-picture-id154945530";
        gs3.Tag = true;
        ...
        gs4.Name = "Engine Servicing";
        gs4.Price = "1500";
        gs4.Content = "A complete service history usually adds to the resale value of a vehicle";
        gs4.Image = "https://media.gettyimages.com/photos/car-engine-repair-picture-id641975348";
        gs4.Tag = false;
        ...
        gs5.Name = "Replace Side Mirrors";
        gs5.Content = "Best quality with warranty";
        gs5.Price = "1100";
        gs5.Image = "https://media.gettyimages.com/photos/side-view-of-a-luxus-car-picture-id157583605";
        gs5.Tag = false;
        ...
        gs6.Name = "Repairing Tires";
        gs6.Price = "700";
        gs6.Content = "Flat tire repair, tire patches and more";
        gs6.Image = "https://media.gettyimages.com/photos/tire-repairer-checking-the-tire-integrity-picture-id621978130";
        gs6.Tag = true;
        ...
        gs7.Name = "Door Service";
        gs7.Content = "Maintaining your car doors and door parts is essential to their effortless function";
        gs7.Price = "500";
        gs7.Image = "https://media.gettyimages.com/photos/auto-mechanic-picture-id598293869";
        gs7.Tag = false;



        GarageService gs8 = new GarageService();
        gs8.Name = "Car Painting";
        gs8.Content = "All types of colors available";
        gs8.Price = "5000";
        gs8.Image = "https://media.gettyimages.com/photos/painting-table-on-white-color-picture-id510976011";
        gs8.Tag = true;

...
import com.maya.wadmin.fragments.pdi.add.AssignTechnicianPDIFragment;
 ...
 * Use the {@link AssignTechnicianLotFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AssignTechnicianLotFragment extends Fragment implements IFragment, IAssignTechnicianPDIAdapter {
    ...
    public AssignTechnicianLotFragment() {
    ...
    public static AssignTechnicianLotFragment newInstance(String param1, String param2) {
        AssignTechnicianLotFragment fragment = new AssignTechnicianLotFragment();
    ...
    public static AssignTechnicianLotFragment newInstance(int vehicleCount) {
        AssignTechnicianLotFragment fragment = new AssignTechnicianLotFragment();
        Bundle args = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_assign_technician_lot, container, false);
        ...
        swipeRefreshLayout.setOnRefreshListener(() ->
        {
            ...
            {
                fetchAssignSalesTechniciansForPreparing();
            }
            else
            {
    ...
    public void fetchAssignSalesTechniciansForPreparing()
    {
        previous = -1;
        progressBar.setVisibility(View.VISIBLE);
        String URL = Constants.URL_LOT_TECHNICIANS + "?DealerId=" + Utility.getString(Utility.getSharedPreferences(),Constants.DEALER_ID);
    ...
    public void updateSearchInTechnician(String content)
    {

 ...
 */
public class RequestPermissionFragment extends Fragment implements IFragment{
...
//    LottieAnimationView lottieAnimationView;
    ...
    public static RequestPermissionFragment newInstance(String param1, String param2) {
    ...
    {
        tvAllow.setOnClickListener(v -> {((SplashActivity)activity()).requestPermissions();});
    }
    ...
    public void showSnackBar(String snackBarText, int type) {
        Utility.showSnackBar(activity(),coordinatorLayout,snackBarText,2);
    }
